  ...
  const docs = [  
    {
      ...
      "url": "/bellman/docs/phases/backwardChaining",
    ...
    } ,    
    {
      ...
      "url": "/bellman/docs/phases/optimization/combineFlatBgps",
    ...
    } ,    
    {
      ...
      "url": "/bellman/docs/phases/dataframeTyper",
    ...
    } ,    
    {
      ...
      "url": "/bellman/docs/inference/domain-range",
    ...
    } ,    
    {
      ...
      "url": "/bellman/docs/inference/equivalentClass",
    ...
    } ,    
    {
      ...
      "url": "/bellman/docs/inference/equivalentProperty",
    ...
    } ,    
    {
      ...
      "url": "/bellman/docs/phases/forwardChaining",
    ...
    } ,    
    {
      ...
      "url": "/bellman/docs/phases/optimization/graphsPushdown",
    ...
    } ,    
    {
      ...
      "url": "/bellman/docs/phases/intersectEntailments",
    ...
    {
      "title": "Intro",
      "url": "/bellman/docs/intro",
      "content": "Intro Bellman is an engine written in Scala that evaluates SPARQL 1.1 queries and executes them over RDF data stored in a Spark cluster. It relies on Apache Jena to parse the SPARQL queries, and on recursion-schemes library Droste to compile the SPARQL algebra into Spark instructions. It can perform inference reasoning when provided with an ontology defined in the RDFS and OWL semantic languages."
    } ,    
    {
      "title": "Join BGPs",
      "url": "/bellman/docs/phases/optimization/joinBgps",
    ...
    } ,    
    {
      ...
      "url": "/bellman/docs/phases/queryEntailmentAnalyzer",
    ...
    } ,    
    {
      ...
      "url": "/bellman/docs/phases/optimization/removeNestedProject",
    ...
    {
      "title": "Reorder BPGs",
      "url": "/bellman/docs/phases/optimization/reorderBgps",
    ...
    } ,    
    {
      ...
      "url": "/bellman/docs/phases/schemaEntailmentAnalyzer",
    ...
    } ,    
    {
      ...
      "url": "/bellman/docs/inference/subclass",
    ...
    } ,    
    {
      ...
      "url": "/bellman/docs/inference/subproperty",
    ...
    } ,    
    {
      ...
      "url": "/bellman/docs/phases/optimization/subqueryPushdown",
    ...
    } ,    
    {
      ...
      "url": "/bellman/docs/phases/validateDataframe",
